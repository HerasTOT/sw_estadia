    ...
    setup() {
        ...
        const eliminar = (id) => {
            Swal.fire({
                ...
                if (res.isConfirmed) {
                    form.delete(route("respuesta.destroy", id));
                }
            });
        };
...
<template>
    <LayoutMain>
        ...
        <CardBox v-if="Respuesta.data.length < 1">
            <CardBoxComponentEmpty />
        </CardBox>
        ...
        <CardBox v-else class="mb-6" has-table>
            <table>
                ...
                <tbody>
                    <tr v-for="item in Respuesta.data" :key="item.id">
            ...
            <Pagination :currentPage="Respuesta.current_page" :links="Respuesta.links"
                :total="Respuesta.links.length - 2"></Pagination>
        </CardBox>

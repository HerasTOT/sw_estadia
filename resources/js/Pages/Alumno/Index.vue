...
<template>
    <LayoutMain>
        ...
        <CardBox v-if="Alumno.data.length < 1">
            <CardBoxComponentEmpty />
        </CardBox>
      ...
      <!-- ... -->
<tbody>
    <tr v-for="item in Alumno.data" :key="item.id">
        ...
        <td data-label="Usuario">
            {{ item.usuarios ? item.usuarios.name + ' ' + item.usuarios.apellido_paterno + ' ' + item.usuarios.apellido_materno : 'N/A' }}
        </td>

...
<template>
    <LayoutMain>
        ...
        <CardBox v-if="Encuesta. data.length < 1">
            <CardBoxComponentEmpty />
        </CardBox>
        ...
        <CardBox v-else class="mb-6" has-table>
            <table>
                ...
                <tbody>
                    <tr v-for="item in Encuesta.data" :key="item.id">
                        ...
                        <td >
                            {{ item.user.name }} {{ item.user.apellido_paterno }} {{ item.user.apellido_materno }}
                        </td>
                        <td >
                            {{ item.estudiantes }}
                        </td>
            ...
            <Pagination :currentPage="Encuesta.current_page" :links="Encuesta.links"
                :total="Encuesta.links.length - 2"></Pagination>
        </CardBox>

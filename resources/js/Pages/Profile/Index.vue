...
<template>
    <LayoutMain>
        ...
        <SectionTitleLineWithButton :icon="mdiTableBorder" :title="titulo" main>
            ...
            <BaseButton :href="route(`${routeName}create`)" color="warning" label=" Agregar estudiante" />
            <BaseButton :href="route(`${routeName}create`)" color="warning" label=" Agregar profesor" />
